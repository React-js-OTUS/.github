...
<a href="https://github.com/React-js-OTUS/react-start-template" target="_blank">Стартовый шаблон</a> - его нужно форкнуть (только ветку main), с его помощью будут выполняться все домашние задания.
